...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							总共${pageInfo.pages } 页，共${pageInfo.total }条数据。 每页 <select id="toPageSize" onchange="javascript:toPage(${pageInfo.pageNum });" class="form-control">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<li><a href="${pageContext.request.contextPath }/order/findAllOrder?pageNum=${pageInfo.pageNum-1 }&pageSize=${pageInfo.pageSize }">上一页</a></li>
							<li><a href="#">1</a></li>
							<li><a href="#">2</a></li>
							<li><a href="#">3</a></li>
							<li><a href="#">4</a></li>
							<li><a href="#">5</a></li>
							<li><a href="${pageContext.request.contextPath }/order/findAllOrder?pageNum=${pageInfo.pageNum+1 }&pageSize=${pageInfo.pageSize }">下一页</a></li>
	...
	<script>
	    ...
	    function toPage(pageNum){
	    	//获取下拉框中选中的value
	    	//$("#toPageSize").val();
	    	var pageSize = document.getElementById("toPageSize").value;
	    	alert(pageNum+"==="+pageSize);
	    	window.location.href="${pageContext.request.contextPath}/order/findAllOrder?pageNum="+pageNum+"&pageSize="+pageSize;
